...
#         geom_line(aes('points', 'tanhSigmoid((points - (5 - 3)) / 5) + tanhSigmoid((points - (5 + 3)) / (-5)) - 1'), color='black') +
#         geom_line(aes('points', 'tanhSigIndicatorWithWidthHeight(6, 5)'), color='black') +
#         geom_line(aes('points', '(tanhSigmoid((points - (5 - 3)) / 5) + tanhSigmoid((points - (5 + 3)) / (-5)) - 1) / tanhSigIndicatorWithWidthHeight(6, 5)'), color='orange') #+
